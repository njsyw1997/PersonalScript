...
json_folder="json"
json_list=["two-cube.json"] 
mesh_folder="../mesh/cube"
...
result_folder="/home/yiwei/result_test/two-cube/novec/t"
...
def run_program(solver_,mesh_,j_file_,discr_order_,n_ref_,block_size_,repeat_time_,num_thread_,eps_strong_=None):
    ...
    json_data["geometry"][1]["mesh"] = mesh_
    json_data["geometry"][1]["n_refs"] =n_ref_ 
