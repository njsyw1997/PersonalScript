...
json_folder="/home/yiwei/PersonalScript/polyfem/newjson/json"
json_list=["mat-twist_new.json"] 
mesh_folder="/home/yiwei/PersonalScript/polyfem/mesh/twist/struct"
# mesh_list=['mat225x225t40.msh','mat150x150t40.msh']
# mesh_list=['mat_20.msh']
# mesh_list=['mat_20.msh','mat_40.msh','mat_60.msh','mat_80.msh','mat100x100t40.msh']
mesh_list=os.listdir(mesh_folder)

# solver_list=["Eigen::PardisoLLT"]
solver_list=["Trilinos","Eigen::PardisoLLT"]
# result_folder="/home/yiwei/result_test/mat-twist-neo/update_vec_newton"
result_folder="/home/yiwei/tmp_test/0.04_1.6_twist"
...
def run_program(solver_,mesh_,j_file_,discr_order_,n_ref_,block_size_,repeat_time_,num_thread_,eps_strong_=None):
    ...
    with tempfile.NamedTemporaryFile(suffix=".json") as tmp_json:
        ...
        p2=subprocess.Popen(['sh', '/home/yiwei/PersonalScript/polyfem/newjson/thread.sh',output_base+"/cpu.txt",str(p1.pid)]) 
                            ...
                            for num_thread in num_threads:
                                for repeat_time in range(repeat_times):
                                    if eps_strong_enable:
                                        ...
                                        assert(os.environ["OMP_NUM_THREADS"]==str(num_thread))
                                        os.chdir(current_folder)
# ./PolyFEM_bin --json /home/yiwei/result_test/mat-twist-neo/restart/Trilinos/mat_60/mat-twist/P1/ref0/block3/Thread8/0/output/restart_0075.json --max_threads 8 --output_dir /home/yiwei/result_test/mat-twist-neo/restart/Trilinos/mat_60/mat-twist/P1/ref0/block3/Thread8/0/tmp_output --no_strict_validation > /home/yiwei/result_test/mat-twist-neo/restart/Trilinos/mat_60/mat-twist/P1/ref0/block3/Thread8/0/tmp_output/log.txt 2>&1